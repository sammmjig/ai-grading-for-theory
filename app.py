...
# Streamlit UI
st.title("AutoExam Demo")
st.info("This demo lets you see the potential of AI in grading theory exams. You can grade student answers based on a marking guide or without one. You can also customize the grading criteria to suit your needs.")
