...
def correctness_score(question: str, answer: str, further_instructions: str, strictness: float) -> float:
    system_message = (
        ...
        "If strictness factor is less than 0.4 over 1, always return maximum mark (1.0) so far the student answer shows the student has an idea even if the idea isn't complete, return maximum mark of 1.0."
