...
def correctness_score(question: str, answer: str, further_instructions: str, strictness: float) -> float:
    system_message = (
        ...
        "If strictness factor is less than 0.4 over 1 ANAD the student answer shows the student has an idea of what the correct answer is even if the idea isn't complete, return maximum mark of 1.0."
