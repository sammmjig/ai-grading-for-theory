...
def similarity_score(question: str, marking_guide: str, answer: str, further_instructions: str, strictness: float) -> float:
    ...
    system_message = (
        ...
        "If strictness factor is less than 0.4 over 1, return maximum mark (1.0) as long as the student answer shows the student has an idea of the correct asnwer even if the idea isn't complete or exactly the same as marking guide, return maximum mark of 1.0."
